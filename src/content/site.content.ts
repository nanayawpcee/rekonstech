...
export const site = {
  ...
  stats: <Stat[]>[
    { value: '15+', countTo: 15, suffix: '+', label: 'Years of Experience', icon: 'award' },
    { value: '99%', countTo: 99, suffix: '%', label: 'Client Satisfaction Rate', icon: 'heart' },
    { value: '24/7', label: 'Managed IT Support', icon: 'life-buoy' },
    { value: 'Enterprise', label: 'Security & Cloud Integration', icon: 'cloud' },
  ],
    ...
    categories: <ServiceCategory[]>[
      {
        ...
        summary: 'Web platforms and business systems built around your workflow, not a template.',
        detailHref: '/services/software-solutions',
        items: [
          {
            icon: 'monitor',
            title: 'Custom Web Applications',
            description: 'Portals, dashboards and internal tools built to your process.',
          },
          {
            icon: 'globe',
            title: 'SME Website Design & Development',
            description: 'Fast, mobile-first sites that turn visitors into enquiries.',
          },
          {
            icon: 'wrench',
            title: 'Ongoing Maintenance & Support',
            description: 'Updates, backups, monitoring and fixes on a fixed monthly plan.',
          },
        ],
      },
      {
        ...
        summary: 'Surveillance, intrusion detection and access control, professionally installed.',
        ...
        items: [
          ...
          },
          {
            ...
            description: 'Zoned detection with instant alerts and response protocols.',
          },
          {
            icon: 'scan-face',
            title: 'Biometric Identification',
            description: 'Fingerprint and facial recognition for access and attendance.',
          },
          {
            icon: 'zap',
            title: 'Power Backup Systems',
            description: 'UPS and solar integration that keeps critical systems live.',
          },
        ],
      },
      {
        ...
        summary: 'Networks engineered for uptime — designed, cabled, configured and documented.',
        detailHref: '/services/networking',
        items: [
          {
            icon: 'wifi',
            title: 'Network Design & Topology',
            description: 'LAN, WAN and enterprise Wi-Fi planned for real coverage.',
          },
          {
            icon: 'globe',
        ...
        items: [
          {
            ...
            description: 'Desktops, laptops and servers specced to your workload.',
          },
          {
            icon: 'keyboard',
            title: 'Accessories & Peripherals',
            description: 'Printers, UPS units, cabling, switches and consumables.',
          },
          {
            icon: 'file-check',
            title: 'Software Licensing & Procurement',
            description: 'Compliant licences with renewal tracking handled for you.',
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            description: 'Roadmaps, audits and system selection you can act on.',
          },
          {
            icon: 'file-check',
            title: 'Compliance Guidance',
            description: 'Data protection and IT governance aligned to regulation.',
          },
          {
            icon: 'graduation-cap',
            title: 'Staff Training & Capacity Building',
            description: 'Practical sessions that make your team self-sufficient.',
          },
        ],
      },
    ],
...
export const serviceCategoryOptions = site.services.categories.map((category) => ({
  value: category.slug,
